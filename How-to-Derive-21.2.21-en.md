...
-\frac{1}{2}\sum_{\alpha\beta}\mu^2_{\alpha\beta}A_\alpha^{\mu}A_{\beta\mu} -\frac{1}{2\xi}\sum_\alpha({\partial_\mu}{A_\alpha^\mu})({\partial_nu}{A_\alpha^\nu})-\frac{1}{2}\sum_n{\partial_{\mu}\phi^{'}_n}{\partial^{\mu}\phi^{'}_n}-\frac{1}{2}\sum_{nm}M^2_{nm}{\phi^{'}_n}{\phi^{'}_m}- {\overline\Psi}({\gamma_\mu}{\partial^\mu} +m)\Psi-\partial_\mu\omega_\alpha^*\partial^\mu\omega_\alpha - \xi\sum_{\alpha\beta}\mu^2_{\alpha\beta}\omega^*_\alpha\omega_\beta+ total derivatives, \quad (21.2.14)
$$
